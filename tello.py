...
#from djitellopy import Telloとして
#mydrone = Tello()としたほうがいい?
mydrone =tello.Tello()
mydrone.connect()
mydrone.streamon()
...
while True:
    ...
    for obj in decoded_objects:
        ...
        for qr_command in qr_data:
            ...
            if command == "takeoff" and value == "1" and not is_taken_off:
                    mydrone.takeoff()
                    is_taken_off = True
            elif command == "land" and value == "1" and is_taken_off and is_land_off:
                    mydrone.land()
                    is_land_off = False
            elif command == "left" and int(value) > 0 and is_taken_off:
